...
if __name__ == '__main__':
    ...
    #JSONSIZES
    dfBestAbsolute = pd.read_csv('/Users/jakobglueck/Desktop/Foldersize/Zeitmessungen/Bestcase/Heartbeats/ZeitMessungen/HeartbeatsJsonRead.txt', delimiter=',',header=None, names=["JsonFile", "FileSize in bytes"], skiprows=1, dtype={"FileSize in bytes": int})
    dfBestDifferential = pd.read_csv('/Users/jakobglueck/Desktop/Foldersize/Zeitmessungen/Bestcase/Heartbeats/ZeitMessungen/HeartbeatsDifferentialJsonRead.txt', delimiter=',', header=None, names=["JsonFile","FileSize in bytes"],skiprows=1, dtype={"FileSize in bytes": int})
    ...
    dfNormalAbsolute = pd.read_csv('/Users/jakobglueck/Desktop/Foldersize/Zeitmessungen/normal/Heartbeats/ZeitMessungen/HeartbeatsJsonRead.txt', delimiter =',', header=None, names=["JsonFile","FileSize in bytes"],skiprows=1, dtype={"FileSize in bytes": int})
    dfNormalDifferential = pd.read_csv('/Users/jakobglueck/Desktop/Foldersize/Zeitmessungen/normal/Heartbeats/ZeitMessungen/HeartbeatsDifferentialJsonRead.txt', delimiter=',', header=None, names=["JsonFile","FileSize in bytes"],skiprows=1, dtype={"FileSize in bytes": int})
    ...
    dataNormalAbsolute1min["Input"] = "Normal"
    dataNormalAbsolute5min['Jsonform'] = 'absoluteJson'
    dataNormalAbsolute5min["Input"] = "Normal"
    dataNormalDifferential1min['Jsonform'] = 'differentialJson'
    dataNormalDifferential1min["Input"] = "Normal"
    dataNormalDifferential5min['Jsonform'] = 'differentialJson'
    dataNormalDifferential5min["Input"] = "Normal"
    ...
    dfWorstAbsolute = pd.read_csv('/Users/jakobglueck/Desktop/Foldersize/Zeitmessungen/Worstcase/Heartbeats/ZeitMessungen/HeartbeatsJsonRead.txt', delimiter=',', header=None, names=["JsonFile", "FileSize in bytes"], skiprows=1, dtype={"FileSize in bytes": int})
    dfWorstDifferential = pd.read_csv('/Users/jakobglueck/Desktop/Foldersize/Zeitmessungen/Worstcase/Heartbeats/ZeitMessungen/HeartbeatsDifferentialJsonRead.txt',delimiter=',', header=None, names=["JsonFile", "FileSize in bytes"], skiprows=1,dtype={"FileSize in bytes": int})
    ...
    dfBestPcore = pd.read_csv( '/Users/jakobglueck/Desktop/Foldersize/Zeitmessungen/Bestcase/Heartbeats/ZeitMessungen/HeartbeatsPcoreRead.txt', delimiter=',',header=None, names=["JsonFile", "FileSize in bytes"], skiprows=1, dtype={"FileSize in bytes": int})
    ...
    dataBestPcore1min["Input"] = "Best"
    dataBestPcore5min["Input"] = "Best"

    dfNormalPcore = pd.read_csv( '/Users/jakobglueck/Desktop/Foldersize/Zeitmessungen/normal/Heartbeats/ZeitMessungen/HeartbeatsPcoreRead.txt', delimiter=',',header=None, names=["JsonFile", "FileSize in bytes"], skiprows=1, dtype={"FileSize in bytes": int})
    ...
    dataNormalPcore1min["Input"] = "Normal"
    dataNormalPcore5min["Input"] = "Normal"


    dfWorstPcore = pd.read_csv( '/Users/jakobglueck/Desktop/Foldersize/Zeitmessungen/Worstcase/Heartbeats/ZeitMessungen/HeartbeatsPcoreRead.txt', delimiter=',',header=None, names=["JsonFile", "FileSize in bytes"], skiprows=1, dtype={"FileSize in bytes": int})
    ...
    dataWorstPcore1min["Input"] = "Worst"
    dataWorstPcore5min["Input"] = "Worst"
    ...
    ax.set_ylabel("Dateigröße in KiB")
    ...
    ax1.set_ylabel("Dateigröße in KiB")
    ...
    ax2.set_ylabel("Dateigröße in KiB")
    ...
    ax3.set_ylabel("Dateigröße in KiB")
