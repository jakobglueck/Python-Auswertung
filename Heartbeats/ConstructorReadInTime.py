...
if __name__ == '__main__':
    ...
    #JSONSIZES
    dfBestAbsolute = pd.read_csv('/Users/jakobglueck/Desktop/Foldersize/Zeitmessungen/Bestcase/Heartbeats/ZeitMessungen/HeartbeatsJsonDataRead.txt', delimiter=',',header=None, names=["JsonFile", "FileSize in bytes"], skiprows=1, dtype={"FileSize in bytes": int})
    ...
    df_Best1min = pd.concat([dataBestAbsolute1min])
    df_Best5min = pd.concat([ dataBestAbsolute5min])





    dfNormalAbsolute = pd.read_csv('/Users/jakobglueck/Desktop/Foldersize/Zeitmessungen/normal/Heartbeats/ZeitMessungen/HeartbeatsJsonDataRead.txt', delimiter =',', header=None, names=["JsonFile","FileSize in bytes"],skiprows=1, dtype={"FileSize in bytes": int})
    ...
    df_Normal1min = pd.concat([dataNormalAbsolute1min])
    df_Normal5min = pd.concat([dataNormalAbsolute5min])

    dfWorstAbsolute = pd.read_csv('/Users/jakobglueck/Desktop/Foldersize/Zeitmessungen/Worstcase/Heartbeats/ZeitMessungen/HeartbeatsJsonDataRead.txt', delimiter=',', header=None, names=["JsonFile", "FileSize in bytes"], skiprows=1, dtype={"FileSize in bytes": int})
    ...
    df_Worst1min = pd.concat([dataWorstAbsolute1min])
    df_Worst5min = pd.concat([dataWorstAbsolute5min])
    ...
    dfBestPcore = pd.read_csv( '/Users/jakobglueck/Desktop/Foldersize/Zeitmessungen/Bestcase/Heartbeats/ZeitMessungen/HeartbeatsDeserialize.txt', delimiter=',',header=None, names=["JsonFile", "FileSize in bytes"], skiprows=1, dtype={"FileSize in bytes": int})
    ...
    dfNormalPcore = pd.read_csv( '/Users/jakobglueck/Desktop/Foldersize/Zeitmessungen/normal/Heartbeats/ZeitMessungen/HeartbeatsDeserialize.txt', delimiter=',',header=None, names=["JsonFile", "FileSize in bytes"], skiprows=1, dtype={"FileSize in bytes": int})
    ...
    dfWorstPcore = pd.read_csv( '/Users/jakobglueck/Desktop/Foldersize/Zeitmessungen/Worstcase/Heartbeats/ZeitMessungen/HeartbeatsDeserialize.txt', delimiter=',',header=None, names=["JsonFile", "FileSize in bytes"], skiprows=1, dtype={"FileSize in bytes": int})
    ...
    sb.violinplot(data=df_allJson1min, x='', y="FileSize in bytes",inner = "quartile", palette="Blues")
    sb.despine(top=True)
    ax.set_ylabel("Zeit in s")
    ax.set_title('(a)', fontsize=10,loc="left")
    ax1 = fig.add_subplot(223)
    sb.violinplot(data=df_allPcore1min, x='', y="FileSize in bytes",inner = "quartile", palette="Blues")
    ax1.set_ylabel("Zeit in s")
    ax1.set_title('(c)', fontsize=10,loc="left")
    sb.set(style="darkgrid")

    ax2 = fig.add_subplot(222)
    sb.violinplot(data=df_allJson5min, x='', y="FileSize in bytes",inner = "quartile", palette="Blues")
    sb.despine(top=True)
    ax2.set_ylabel("Zeit in s")
    ax2.set_title('(b)', fontsize=10,loc="left")

    ax3 = fig.add_subplot(224)
    sb.violinplot(data=df_allPcore5min, x='', y="FileSize in bytes",inner = "quartile", palette="Blues")
