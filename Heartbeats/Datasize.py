...
if __name__ == '__main__':
    ...
    #JSONSIZES
    dfBestAbsolute = pd.read_csv('/Users/jakobglueck/Desktop/Foldersize/bestcase/Heartbeats/absoluteJsonHeartbeats/FileSizes.txt', delimiter=',',header=None, names=["JsonFile", "FileSize in bytes"], skiprows=1, dtype={"FileSize in bytes": int})
    dfBestDifferential = pd.read_csv('/Users/jakobglueck/Desktop/Foldersize/bestcase/Heartbeats/differentialJsonHeartbeats/FileSizes.txt', delimiter=',', header=None, names=["JsonFile","FileSize in bytes"],skiprows=1, dtype={"FileSize in bytes": int})
    ...
    dfNormalAbsolute = pd.read_csv('/Users/jakobglueck/Desktop/Foldersize/Heartbeats/absoluteJsonHeartbeats/FileSizes.txt', delimiter =',', header=None, names=["JsonFile","FileSize in bytes"],skiprows=1, dtype={"FileSize in bytes": int})
    dfNormalDifferential = pd.read_csv('/Users/jakobglueck/Desktop/Foldersize/Heartbeats/differentialJsonHeartbeats/FileSizes.txt', delimiter=',', header=None, names=["JsonFile","FileSize in bytes"],skiprows=1, dtype={"FileSize in bytes": int})
    ...
    dfWorstAbsolute = pd.read_csv('/Users/jakobglueck/Desktop/Foldersize/worstcase/Heartbeats/absoluteJsonHeartbeats/FileSizes.txt', delimiter=',', header=None, names=["JsonFile", "FileSize in bytes"], skiprows=1, dtype={"FileSize in bytes": int})
    dfWorstDifferential = pd.read_csv('/Users/jakobglueck/Desktop/Foldersize/worstcase/Heartbeats/differentialJsonHeartbeats/FileSizes.txt',delimiter=',', header=None, names=["JsonFile", "FileSize in bytes"], skiprows=1,dtype={"FileSize in bytes": int})
    ...
    dfBestPcore = pd.read_csv( '/Users/jakobglueck/Desktop/Foldersize/bestcase/Heartbeats/pcoreHeartbeats/FileSizes.txt', delimiter=',',header=None, names=["JsonFile", "FileSize in bytes"], skiprows=1, dtype={"FileSize in bytes": int})
    ...
    dfNormalPcore = pd.read_csv( '/Users/jakobglueck/Desktop/Foldersize/Heartbeats/pcoreHeartbeats/FileSizes.txt', delimiter=',',header=None, names=["JsonFile", "FileSize in bytes"], skiprows=1, dtype={"FileSize in bytes": int})
    ...
    dfWorstPcore = pd.read_csv( '/Users/jakobglueck/Desktop/Foldersize/worstcase/Heartbeats/pcoreHeartbeats/FileSizes.txt', delimiter=',',header=None, names=["JsonFile", "FileSize in bytes"], skiprows=1, dtype={"FileSize in bytes": int})
