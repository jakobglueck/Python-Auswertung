...
if __name__ == '__main__':
    ...
    #JSONSIZES
    dfBestAbsolute = pd.read_csv('/Users/jakobglueck/Desktop/Foldersize/Zeitmessungen/Bestcase/Heartbeats/ZeitMessungen/HeartbeatsWritePcoreJson.txt', delimiter=',',header=None, names=["JsonFile", "FileSize in bytes"], skiprows=1, dtype={"FileSize in bytes": int})
    dfBestDifferential = pd.read_csv('/Users/jakobglueck/Desktop/Foldersize/Zeitmessungen/Bestcase/Heartbeats/ZeitMessungen/HeartbeatsWriteDifferentialJson.txt', delimiter=',', header=None, names=["JsonFile","FileSize in bytes"],skiprows=1, dtype={"FileSize in bytes": int})
    ...
    dfNormalAbsolute = pd.read_csv('/Users/jakobglueck/Desktop/Foldersize/Zeitmessungen/normal/Heartbeats/ZeitMessungen/HeartbeatsWritePcoreJson.txt', delimiter =',', header=None, names=["JsonFile","FileSize in bytes"],skiprows=1, dtype={"FileSize in bytes": int})
    dfNormalDifferential = pd.read_csv('/Users/jakobglueck/Desktop/Foldersize/Zeitmessungen/normal/Heartbeats/ZeitMessungen/HeartbeatsWriteDifferentialJson.txt', delimiter=',', header=None, names=["JsonFile","FileSize in bytes"],skiprows=1, dtype={"FileSize in bytes": int})
    ...
    dfWorstAbsolute = pd.read_csv('/Users/jakobglueck/Desktop/Foldersize/Zeitmessungen/Worstcase/Heartbeats/ZeitMessungen/HeartbeatsWritePcoreJson.txt', delimiter=',', header=None, names=["JsonFile", "FileSize in bytes"], skiprows=1, dtype={"FileSize in bytes": int})
    dfWorstDifferential = pd.read_csv('/Users/jakobglueck/Desktop/Foldersize/Zeitmessungen/Worstcase/Heartbeats/ZeitMessungen/HeartbeatsWriteDifferentialJson.txt',delimiter=',', header=None, names=["JsonFile", "FileSize in bytes"], skiprows=1,dtype={"FileSize in bytes": int})
    ...
    dfBestPcore = pd.read_csv( '/Users/jakobglueck/Desktop/Foldersize/Zeitmessungen/Bestcase/Heartbeats/ZeitMessungen/HeartbeatsPcoreWrite.txt', delimiter=',',header=None, names=["JsonFile", "FileSize in bytes"], skiprows=1, dtype={"FileSize in bytes": int})
    ...
    dfNormalPcore = pd.read_csv( '/Users/jakobglueck/Desktop/Foldersize/Zeitmessungen/normal/Heartbeats/ZeitMessungen/HeartbeatsPcoreWrite.txt', delimiter=',',header=None, names=["JsonFile", "FileSize in bytes"], skiprows=1, dtype={"FileSize in bytes": int})
    ...
    dfWorstPcore = pd.read_csv( '/Users/jakobglueck/Desktop/Foldersize/Zeitmessungen/Worstcase/Heartbeats/ZeitMessungen/HeartbeatsPcoreWrite.txt', delimiter=',',header=None, names=["JsonFile", "FileSize in bytes"], skiprows=1, dtype={"FileSize in bytes": int})
