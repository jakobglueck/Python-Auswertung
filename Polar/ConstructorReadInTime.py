...
if __name__ == '__main__':
    ...
    #JSONSIZES
    dfBestAbsolute = pd.read_csv('/Users/jakobglueck/Desktop/Foldersize/Zeitmessungen/Bestcase/Polar/ZeitMessungen/PolarbeatsJsonDataRead.txt', delimiter=',',header=None, names=["JsonFile", "FileSize in bytes"], skiprows=1, dtype={"FileSize in bytes": int})
    # dfBestDifferential = pd.read_csv('/Users/jakobglueck/Desktop/Foldersize/Zeitmessungen/Bestcase/Polar/ZeitMessungen/PolarbeatsWriteDifferentialJson.txt', delimiter=',', header=None, names=["JsonFile","FileSize in bytes"],skiprows=1, dtype={"FileSize in bytes": int})
    ...
    df_BestCoordinate = pd.concat([dataBestAbsoluteCoordinate])
    df_BestNorm = pd.concat([ dataBestAbsoluteNorm])





    dfNormalAbsolute = pd.read_csv('/Users/jakobglueck/Desktop/Foldersize/Zeitmessungen/normal/Polar/ZeitMessungen/PolarbeatsJsonDataRead.txt', delimiter =',', header=None, names=["JsonFile","FileSize in bytes"],skiprows=1, dtype={"FileSize in bytes": int})
    # dfNormalDifferential = pd.read_csv('/Users/jakobglueck/Desktop/Foldersize/Zeitmessungen/normal/Polar/ZeitMessungen/PolarbeatsWriteDifferentialJson.txt', delimiter=',', header=None, names=["JsonFile","FileSize in bytes"],skiprows=1, dtype={"FileSize in bytes": int})
    ...
    df_NormalCoordinate = pd.concat([dataNormalAbsoluteCoordinate])
    df_NormalNorm = pd.concat([dataNormalAbsoluteNorm])

    dfWorstAbsolute = pd.read_csv('/Users/jakobglueck/Desktop/Foldersize/Zeitmessungen/Worstcase/Polar/ZeitMessungen/PolarJsonDataRead.txt', delimiter=',', header=None, names=["JsonFile", "FileSize in bytes"], skiprows=1, dtype={"FileSize in bytes": int})
    # dfWorstDifferential = pd.read_csv('/Users/jakobglueck/Desktop/Foldersize/Zeitmessungen/Worstcase/Polar/ZeitMessungen/PolarWriteDifferentialJson.txt',delimiter=',', header=None, names=["JsonFile", "FileSize in bytes"], skiprows=1,dtype={"FileSize in bytes": int})
    ...
    df_WorstCoordinate = pd.concat([dataWorstAbsoluteCoordinate])
    df_WorstNorm = pd.concat([dataWorstAbsoluteNorm])
    ...
    dfBestPcore = pd.read_csv( '/Users/jakobglueck/Desktop/Foldersize/Zeitmessungen/Bestcase/Polar/ZeitMessungen/PolarbeatsDeserialize.txt', delimiter=',',header=None, names=["JsonFile", "FileSize in bytes"], skiprows=1, dtype={"FileSize in bytes": int})
    ...
    dfNormalPcore = pd.read_csv( '/Users/jakobglueck/Desktop/Foldersize/Zeitmessungen/normal/Polar/ZeitMessungen/PolarbeatsDeserialize.txt', delimiter=',',header=None, names=["JsonFile", "FileSize in bytes"], skiprows=1, dtype={"FileSize in bytes": int})
    ...
    dfWorstPcore = pd.read_csv( '/Users/jakobglueck/Desktop/Foldersize/Zeitmessungen/Worstcase/Polar/ZeitMessungen/PolarDeserialize.txt', delimiter=',',header=None, names=["JsonFile", "FileSize in bytes"], skiprows=1, dtype={"FileSize in bytes": int})
    ...
    sb.violinplot(data=df_allJsonCoordinate, x='', y="FileSize in bytes",inner = "quartile", palette="Blues")
    sb.despine(top=True)
    ax.set_ylabel("Zeit in s")
    ax.set_title('(a)', fontsize=10,loc="left")
    ax1 = fig.add_subplot(223)
    sb.violinplot(data=df_allPcoreCoordinate, x='', y="FileSize in bytes",inner = "quartile", palette="Blues")
    ax1.set_ylabel("Zeit in s")
    ax1.set_title('(c)', fontsize=10,loc="left")
    sb.set(style="darkgrid")

    ax2 = fig.add_subplot(222)
    sb.violinplot(data=df_allJsonNorm, x='', y="FileSize in bytes",inner = "quartile", palette="Blues")
    sb.despine(top=True)
    ax2.set_ylabel("Zeit in s")
    ax2.set_title('(b)', fontsize=10,loc="left")

    ax3 = fig.add_subplot(224)
    sb.violinplot(data=df_allPcoreNorm, x='', y="FileSize in bytes",inner = "quartile", palette="Blues")
