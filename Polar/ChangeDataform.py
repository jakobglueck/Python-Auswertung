...
if __name__ == '__main__':
    ...
    #JSONSIZES
    dfBestAbsolute = pd.read_csv('/Users/jakobglueck/Desktop/Foldersize/Zeitmessungen/Bestcase/Polar/ZeitMessungen/PolarbeatsToJson.txt', delimiter=',',header=None, names=["JsonFile", "FileSize in bytes"], skiprows=1, dtype={"FileSize in bytes": int})
    dfBestDifferential = pd.read_csv('/Users/jakobglueck/Desktop/Foldersize/Zeitmessungen/Bestcase/Polar/ZeitMessungen/PolarbeatsToDifferentialJson.txt', delimiter=',', header=None, names=["JsonFile","FileSize in bytes"],skiprows=1, dtype={"FileSize in bytes": int})
    ...
    dfNormalAbsolute = pd.read_csv('/Users/jakobglueck/Desktop/Foldersize/Zeitmessungen/normal/Polar/ZeitMessungen/PolarbeatsToJson.txt', delimiter =',', header=None, names=["JsonFile","FileSize in bytes"],skiprows=1, dtype={"FileSize in bytes": int})
    dfNormalDifferential = pd.read_csv('/Users/jakobglueck/Desktop/Foldersize/Zeitmessungen/normal/Polar/ZeitMessungen/PolarbeatsToDifferentialJson.txt', delimiter=',', header=None, names=["JsonFile","FileSize in bytes"],skiprows=1, dtype={"FileSize in bytes": int})
    ...
    dfWorstAbsolute = pd.read_csv('/Users/jakobglueck/Desktop/Foldersize/Zeitmessungen/Worstcase/Polar/ZeitMessungen/PolarToJson.txt', delimiter=',', header=None, names=["JsonFile", "FileSize in bytes"], skiprows=1, dtype={"FileSize in bytes": int})
    dfWorstDifferential = pd.read_csv('/Users/jakobglueck/Desktop/Foldersize/Zeitmessungen/Worstcase/Polar/ZeitMessungen/PolarToDifferentialJson.txt',delimiter=',', header=None, names=["JsonFile", "FileSize in bytes"], skiprows=1,dtype={"FileSize in bytes": int})
    ...
    dfBestPcore = pd.read_csv( '/Users/jakobglueck/Desktop/Foldersize/Zeitmessungen/Bestcase/Polar/ZeitMessungen/PolarbeatsSerialize.txt', delimiter=',',header=None, names=["JsonFile", "FileSize in bytes"], skiprows=1, dtype={"FileSize in bytes": int})
    ...
    dfNormalPcore = pd.read_csv( '/Users/jakobglueck/Desktop/Foldersize/Zeitmessungen/normal/Polar/ZeitMessungen/PolarbeatsSerialize.txt', delimiter=',',header=None, names=["JsonFile", "FileSize in bytes"], skiprows=1, dtype={"FileSize in bytes": int})
    ...
    dfWorstPcore = pd.read_csv( '/Users/jakobglueck/Desktop/Foldersize/Zeitmessungen/Worstcase/Polar/ZeitMessungen/PolarSerialize.txt', delimiter=',',header=None, names=["JsonFile", "FileSize in bytes"], skiprows=1, dtype={"FileSize in bytes": int})
